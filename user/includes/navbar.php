...
<nav class="navbar navbar-expand-lg navbar-dark p-4" style="background-color: #ffffff; color: #27292b;">
  <a class="navbar-brand" style="color: #1d5db1; font-weight: 500; font-size: 20px;" href="index.php">Google Docs Clone</a>
    ...
    <div class="navbar-nav">
      ...
      <div class="nav-right">
        <div class="nav-item mt-3">
          <p> Hello,<button style="color: #1d5db1; font-size: 18px; background-color: #ffffff; border: none;">  <?php echo $_SESSION['username']; ?></button></p>
        </div>
